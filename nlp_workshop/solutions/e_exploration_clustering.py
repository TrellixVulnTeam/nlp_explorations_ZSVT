...
* apply 2 common clustering algorithms (optionally a third one)
...
def agglomerative_clustering(vectors):
    ...
    # the scikit-learn library (Python library for machine-learning-related tasks)
    # got it for us.
    ...
    model = model.fit(vectors)  # TODO: model = model.fit(TODO)
...
def k_means_clustering(vectors, documents):
    ...
    # TODO REMOVE
    """
    2 clusters (seems best): cluster 1 is about food, the remainder is in cluster 0
    3 clusters: cluster 0 is about the recipe, 2 about food, the remainder in 1
    4 clusters: 0 about computers and smartphones and vaccines, 1 about food, 2 about recipe, 3 about retail
    """
...
def affinity_propagation_clustering(vectors, documents):
    ...
    # Hint: Google "scikit learn affinity propagation"
    # TODO REMOVE
...
def pipeline():
    ...
    # TODO Call the predict function
    # Hint: https://scikit-learn.org/stable/modules/generated/sklearn.cluster.KMeans.html#sklearn.cluster.KMeans.predict
    # Hint 2: You only need to pass one argument, the variable new_vector
    cluster_labels = model.predict(new_vectors)
