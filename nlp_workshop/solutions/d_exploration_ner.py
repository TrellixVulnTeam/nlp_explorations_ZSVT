...
out what the most frequent persons are and what they do - without ever reading any of
...
def get_gpes_and_mentions(docs):
    ...
    for doc in docs:
        ...
        for ent in doc.ents:
            ...
            # "ent.label_"
            entity_type = ent.label_  # TODO
            if entity_type == "GPE":  # TODO
...
def find_actions_of_gpe(gpe_mentions):
    ...
    for gpe_mention in gpe_mentions:
        ...
        sentence = gpe_mention.sent  # TODO: sentence_of_mention = gpe_mention...
        ...
        for token in sentence:
            ...
            if pos_of_token == "VERB":
                ...
                #  difference between a verb and its lemmatized version?

    # Finally, let's get sort the verbs by how often they occur
