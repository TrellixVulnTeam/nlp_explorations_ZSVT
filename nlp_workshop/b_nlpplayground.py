"""
This file may serve as a sandbox to get an understanding of a few common tasks that
spacy, a state-of-the-art Python library for common NLP tasks, can do. Most of the
examples are taken from spacy's website, e.g., https://spacy.io/usage/spacy-101#features
